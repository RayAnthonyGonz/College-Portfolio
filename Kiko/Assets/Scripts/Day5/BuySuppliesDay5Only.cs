...
public class BuySuppliesDay5Only : MonoBehaviour
{
    //Playerstats reference
    public PlayerStats playerStats;

    //day quest trigger reference
    ...
    void Update()
    {
        ...
        {
            if (iconIsActive == true && day5QuestTriggers.hasTalkedTopher == false 
            && day5QuestTriggers.boughtTopherSupplies == true)
            {
    ...
    {
        if (other.tag == "Player" && day5QuestTriggers.hasTalkedTopher == false 
        && day5QuestTriggers.boughtTopherSupplies == true)
        {
