...
public class fortifyTrigger : MonoBehaviour
{
    ...
    void Start()
    {
        this.interactIcon = GameObject.Find("Interact Icon Fortify");
    ...
    void Update()
    {
        ...
        {
            if (iconIsActive == true && day5Triggers.buyFortMat == true && hasFortified == false)
            {
                dRunner.StartDialogue("fortifying");
    ...
    {
        if (other.tag == "Player" && day5Triggers.buyFortMat == true && hasFortified == false)
        {
