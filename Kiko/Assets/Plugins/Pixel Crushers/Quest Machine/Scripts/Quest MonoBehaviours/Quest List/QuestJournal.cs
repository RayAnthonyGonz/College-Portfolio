...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestJournal : IdentifiableQuestListContainer, IMessageHandler
    {
        ...
        public override void OnEnable()
        {
            ...
            if (onlyTrackOneQuestAtATime) MessageSystem.AddListener(this, QuestMachineMessages.QuestTrackToggleChangedMessage, string.Empty);
        }
        ...
        public override void OnMessage(MessageArgs messageArgs)
        {
            ...
            switch (messageArgs.message)
            {
                ...
                case QuestMachineMessages.QuestTrackToggleChangedMessage:
                    CheckTrackingToggles(messageArgs.parameter);
                    break;
            }
        }
        ...
        {
            if (!onlyTrackOneQuestAtATime) return;
            var quest = FindQuest(questID);
            if (quest == null || !quest.showInTrackHUD) return;
            var changed = false;
